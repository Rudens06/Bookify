defmodule BookifyWeb.CoreComponents do
  @moduledoc """
  ...
  def input(assigns) do
    ~H"""
    <div phx-feedback-for={@name} class="my-5">
      <.label for={@id}><%= @label %></.label>
      <input
        type={@type}
        name={@name}
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BookifyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BookifyWeb.Gettext, "errors", msg, opts)
    end
  end
